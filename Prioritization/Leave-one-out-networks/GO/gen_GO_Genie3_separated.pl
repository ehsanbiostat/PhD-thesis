...
for(my $i=1;$i<148;$i++){
  my $jobfile="GO".$i."_Genie3_separated.r";
  open(OUT,">$jobfile");
  print OUT  "load(\"~/prioritization/Combined_Network/New/Leave_one_out/Genie3.RData\")
...
save(w, file=\"~/prioritization/Leave-one-out/New/Leave-one-out-network/GO/Genie3_GO_separated".$i.".RData\")";
   close OUT;
}
