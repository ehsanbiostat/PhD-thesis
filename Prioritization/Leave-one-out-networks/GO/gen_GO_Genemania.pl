...
write.table(c, file=\"~/prioritization/Leave-one-out/New/Leave-one-out-network/GO/Genemania_GO".$i.".txt\",col.names=T,row.names=F,sep=\"\\t\")";
   close OUT;
}
