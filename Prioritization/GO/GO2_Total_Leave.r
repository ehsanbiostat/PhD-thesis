...
load("/ngsprojects/iwt/ehsab/Prioritization/prioritization/Leave-one-out/New/Total_topology/Leave-one-out.RData")  # Whole Network data sets
...
# Reading each left-out dataset
  ...
  data=data.frame(Y=a1$y,alldeg=a1[,2],decregiyg=a1[,3],cregiyg_sh=a1[,4],bet=a1[,5],clos=a1[,6]
  ,klein=a1[,7],jaccard=a1[,8],sim.dic=a1[,9],sim.we=a1[,10],short=a1[,11],PTC=a1[,18],PFC=a1[,19],P5C=a1[,20],JQC=a1[,21],JNC=a1[,22],JC=a1[,23],PTF=a1[,24],PFF=a1[,25],P5F=a1[,26],JQF=a1[,27],JNF=a1[,28]
  ,JF=a1[,29],PTP=a1[,30],PFP=a1[,35],P5P=a1[,32],JQP=a1[,33],JNP=a1[,34],JP=a1[,35])
  model=glm(Y~alldeg+decregiyg+cregiyg_sh+bet+clos+klein+jaccard+sim.dic+sim.we+short
...
write.table(com,file="~/prioritization/Leave-one-out/New/GO/Results/GO2.txt",sep="\t",col.names=T,row.names=F)