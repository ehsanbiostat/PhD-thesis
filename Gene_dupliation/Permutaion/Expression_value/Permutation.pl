...
SA_gene_score = read.table(\"/group/biocomp/users/ehsab/Gene_duplication/Results/SA/Gene_score/Total/G_Total.SD".$j.".txt\", header = T)
SA_cond_score = read.table(\"/group/biocomp/users/ehsab/Gene_duplication/Results/SA/Condition_score/Total/C_Total.SD".$j.".txt\", header = T)
...
write.table(gene_score_module, file = \"/ngsprojects/iwt/ehsab/Gene_duplication/Results/SA/Gene_score/Permutation/Scores/G_Total.SD".$j.".txt\", row.names = F, col.names = T, sep = \"\\t\")
write.table(cond_score_module, file = \"/ngsprojects/iwt/ehsab/Gene_duplication/Results/SA/Condition_score/Permutation/Scores/C_Total.SD".$j.".txt\", row.names = F, col.names = T, sep = \"\\t\")

write.table(thresh_gene_score, file = \"/ngsprojects/iwt/ehsab/Gene_duplication/Results/SA/Gene_score/Permutation/Threshold95/G_Thresh.SD".$j.".txt\", row.names = F, col.names = F, sep = \"\\t\")
write.table(thresh_cond_score, file = \"/ngsprojects/iwt/ehsab/Gene_duplication/Results/SA/Condition_score/Permutation/Threshold95/C_Thresh.SD".$j.".txt\", row.names = F, col.names = F, sep = \"\\t\")
...
write.table(thresh_gene_score, file = \"/ngsprojects/iwt/ehsab/Gene_duplication/Results/SA/Gene_score/Permutation/Threshold99/G_Thresh.SD".$j.".txt\", row.names = F, col.names = F, sep = \"\\t\")
write.table(thresh_cond_score, file = \"/ngsprojects/iwt/ehsab/Gene_duplication/Results/SA/Condition_score/Permutation/Threshold99/C_Thresh.SD".$j.".txt\", row.names = F, col.names = F, sep = \"\\t\")
