...
load("/scratch/iwt/ehsab/Gene_duplication/Results/SA/Grape/Compendium_wise/biotic/Score99/Threshold/Threshold.RData")
...
Result = foreach (i = 1:19787, .combine = rbind) %dopar%{
	print(i)
	...
	a11[(a11$Normalized.orthologous.cluster > a11$Threshold95) & a11$orthologous.cluster > 1, ]
