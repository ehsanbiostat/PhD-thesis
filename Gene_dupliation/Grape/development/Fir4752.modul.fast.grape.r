...
# registerDoMC(14)
	...
	write.table(Score, file = paste("/scratch/iwt/ehsab/Gene_duplication/Results/SA/Grape/Compendium_wise/",NAME[k],"/Score99/Scores_V2/Score4752.txt", sep = ""), row.names = F, quote = F, sep = "\t")
