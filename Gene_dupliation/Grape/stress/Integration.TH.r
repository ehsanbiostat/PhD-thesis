...
setwd("/scratch/iwt/ehsab/Gene_duplication/Results/SA/Grape/Compendium_wise/abiotic/Score99/")
...
G.score = G.score[order(-G.score[, "Normalized.orthologous.cluster"]), ]

save(G.score, file = "/scratch/iwt/ehsab/Gene_duplication/Results/SA/Grape/Compendium_wise/abiotic/Score99/G.score.RData")
# --------------------------------------------------------------------------------------------------------------------------------
...
setwd("/scratch/iwt/ehsab/Gene_duplication/Results/SA/Local/Compendium_wise/abiotic/Score99/")
g = lapply(list, read.table, sep= "\t" , header=T)
...
A.score = A.score[order(-A.score[, "Normalized.Paralogous.cluster"]), ]
save(A.score, file = "/scratch/iwt/ehsab/Gene_duplication/Results/SA/Local/Compendium_wise/abiotic/Score99/A.score.RData")
# --------------------------------------------------------------------------------------------------------------------------------
