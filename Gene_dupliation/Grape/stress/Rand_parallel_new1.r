...
load("/scratch/iwt/ehsab/Gene_duplication/Results/SA/Grape/Compendium_wise/abiotic/Score99/Threshold/Threshold.RData")
...
Result = foreach (i = 1:7179) %dopar%{
	...
	Result = a11[(a11$Normalized.orthologous.cluster > a11$Threshold95) & a11$orthologous.cluster > 1, ]
