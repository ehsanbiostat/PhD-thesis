...
load(\"/scratch/iwt/ehsab/Gene_duplication/Results/SA/Local/Grape/data.norm.stress.RData\")
	...
	save(gene_score_module, file = paste(\"/scratch/iwt/ehsab/Gene_duplication/Results/SA/Grape/Permutation/stress/Gene_score/V2/G\",j,\".RData\", sep = \"\"))
	save(cond_score_module, file = paste(\"/scratch/iwt/ehsab/Gene_duplication/Results/SA/Grape/Permutation/stress/Condition_score/V2/C\",j,\".RData\", sep = \"\"))
